...
def otp_cipher_encoding(text, key):
...
def otp_cipher_decoding(text, key):
...
encoded_msg = otp_cipher_encoding(text,key_text)
decoded_msg = otp_cipher_decoding(encoded_msg , key_text)
